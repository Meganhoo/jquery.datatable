$(document).ready(function() {
            $("selctor").dataTable({
                ...
                */
                ...
                /*
                 * 默认为true
                 * 是否允许终端用户从一个选择列表中选择分页的页数，页数为，，和，需要分页组件bPaginate的支持
                 */
                ...
                /*
                 * 默认为true
                 * 是否在当前被排序的列上额外添加sorting_,sorting_,sorting_三个class，当该列被排序的时候，可以切换其背景颜色
             ...
             * iDisplayStart
             * 默认为
             * 当开启分页的时候，定义展示的记录的起始序号，不是页数，因此如果你每个分页有条记录而且想从第三页开始
             * 需要把该参数指定为
             */
            $(document).ready(function() {
                $('#example').dataTable({
             ...
             * 允许你通过tab键切换控制组件，使用回车键去激活他们，默认为表示按照文档流来切换
             * 如果需要的话，你可以使用该参数重写切换顺序，使用-来禁止内建的键盘导航
             */
            $(document).ready(function() {
                $('#example').dataTable({
                    "iTabIndex":
             ...
             * fnFormatNumber
             * 无默认值
             * 当渲染表格信息（例如：显示条记录中的-条）中大的数字时
             * 为了方便用户，DataTable会使用逗号分割每千单位（例如会被渲染为,,）
                        ...
                        $(document).ready(function() {
                            ...
                            $(document).ready(function() {
                                ...
                                $(document).ready(function() {
                                     ...
                                     * 注意只有能够被Javascript的Date对象接受的格式化日期字符串才会被当作日期类型接受，例如"Mar ,  : PM"
                                     ...
                                     * sWidth
                                     * 默认值为null,自动的
                                     * 定义列的宽度，该参数可以接受CSS定义（em,px等），DataTable对没有通过该接口指定宽度的列使用灵活宽度
                                     * 从而保证表格是可被读的
                                     */
                                    // Using aoColumnDefs
                                    $(document).ready(function() {
